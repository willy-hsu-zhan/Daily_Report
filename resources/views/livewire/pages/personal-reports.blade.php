                ...
                <div id="custom-background">
                    <div class="center">
                        <div class="col-md-6" bis_skin_checked="1">
                            <a href="#" wire:click="loadYesterdayData">
                        ...
                        <div class="col-md-6" bis_skin_checked="1">
                            <a href="#" wire:click="loadLastWeekData">
                        ...
                        <div class="col-md-6 mt-3" bis_skin_checked="1">
                            <a href="#" wire:click="loadLastMonthData">
                    ...
                    <table class="table">
                        <thead class="thead-pink">
                            <tr>
                                ...
                                <th>USER</th>
                                <th>花費時間</th>
                                @if($is_ignore_query_project_id) <th>專案</th> @endif
                                <th>工作內容</th>
                                <th>進度</th>
                                <th>工作類別</th>
                            </tr>
